CREATE TABLE public.files (
    ...
    "hasContent" boolean DEFAULT false NOT NULL
);
COMMENT ON TABLE public.files IS 'All files uploaded to the database';
COMMENT ON COLUMN public.files."mimeType" IS 'The MIME type of the file';
COMMENT ON COLUMN public.files."hasContent" IS 'Whether this file has content or not';
